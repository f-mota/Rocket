...
// Generación del listado de todas las entregas (Reporte General)
...
<head>
    <meta charset="UTF-8">
    <title>Reporte General de Entregas</title>
...
<body style="margin: 0 2% 0 2%;">
    ...
    <div class="header-pdf">
        ...
        <h1>Reporte General de Entregas de Vehículos</h1>
        <p>Generado el: <?php echo date("d/m/Y H:i:s"); ?></p>
        <p>Total de Entregas en el Reporte: <strong><?php echo $CantidadEntregas; ?></strong></p>
    </div>
    ...
    <?php } else { ?>
        <p style="text-align: center; color: #a80a0a; font-weight: bold; margin-top: 30px;">
            No se encontraron registros de entregas para este reporte.
        </p>
    <?php } ?>
...
$dompdf->stream("ReporteEntregas", array("Attachment" => false));
